...
if(isset($_GET['action']) && isset($_GET['id']) && isset($_GET['eandid'])){
    ...
    if($delete_vale == true){
      echo "<script>alert('Successfully Deleted.');window.location.href='$url/admin-manager/all-product/';</script>";
	}else{
...
if(isset($_GET['hide']) && isset($_GET['id']) && isset($_GET['eandid']) && isset($_GET['vt'])){
    ...
    if($delete_vale == true){
      echo "<script>alert('Successfully Updated.');window.location.href='$url/admin-manager/all-product/';</script>";
  }else{
    echo "<script>alert('Please Try Again.');</script>"; 
  }
}
                    ...
                    <tr>
                      ...
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          <a href="<?php echo $url; ?>/admin-manager/all-product/?pageid=<?php echo $productdetils['id']; ?>&duplicate=<?php echo $productdetils['product_auto_id']; ?>" target="_blank" class="btn btn-info"><i class="fa fa-files-o"></i></a>
                        </div>
                      </td>
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          ...
                          ?>
                          <a href="<?php echo $url; ?>/admin-manager/all-product/?hide=hide&id=<?php echo $productdetils['id']; ?>&eandid=<?php echo $productdetils['product_auto_id'];?>&vt=0" class="btn btn-info" title="Click and hide"><i class="fa fa-eye"></i></a>
                          <?php
                            }else{
                          ?>
                          <a href="<?php echo $url; ?>/admin-manager/all-product/?hide=hide&id=<?php echo $productdetils['id']; ?>&eandid=<?php echo $productdetils['product_auto_id'];?>&vt=1" class="btn btn-danger" title="Click and show"><i class="fa fa-eye-slash"></i></a>
                          <?php
                            }
                          ?>
                        </div>
                      ...
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          ...
                          <button type="button" class="btn btn-danger deletebtn" data-toggle="modal" data-target="#delete" data-id="<?php echo $url; ?>/admin-manager/all-product/?action=delete&id=<?php echo $productdetils['id']; ?>&eandid=<?php echo $productdetils['product_auto_id'];?>"><i class="fas fa-trash"></i></button>
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
